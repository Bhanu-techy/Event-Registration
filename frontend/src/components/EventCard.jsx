...
function EventCard({details}) {
  ...
  return (
    <Link to={`/event/${id}`}>
    <li className=' w-[280px] h-[280px] rounded-full bg-pink-100 hover:shadow-yellow-200 flex flex-col justify-center items-center shadow-lg shadow-purple-200 m-5 pl-3 p-5'>
